...
\begin{document}
	...
	Avec 444 blagues\footnote{Et seulement 370 notes de bas de page~!}% Plus des blagues qui n'ont pas été publiées : si vous lisez cela, vous pourrez y accéder !
	...
	\begin{enumerate}
		...
		\item C'est un stagiaire en développement qui utilise Git pour la première fois. Il veut récupérer la dernière version de la branche principale du projet. Donc on lui dit de faire un \textbf{git pull} mais rien n'y fait, ça ne marche pas. Au bout de longues minutes, son tuteur (manifestement excédé) jette un œil sur son PC et s'aperçoit qu'il a tapé \textbf{git }
        %\item...
	...
	\newpage
	\begin{enumerate}
		\item {\NotoEmoji\symbol{"1F343}}Why does the population decrease in Turkey during the Thanksgiving? Because during this day, Americans eat turkey.

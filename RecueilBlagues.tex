...
\begin{document}
	...
	Ce recueil de blagues vous donnera le sourire dès le premier calembour (ou vous rassurera sur votre niveau de blagues) et vous permettra de faire rire vos voisins~! \\Avec 436 blagues% Plus des blagues qui n'ont pas été publiées : si vous lisez cela, vous pourrez y accéder ! 
...
%		\item Pourquoi les grands-pères en Russie sont-ils aussi vieux~? Car ce sont des papis russes\footnote{Des papyrus. Hahahaha~!!!!}.
	...
	\section{Infos}
	\textit{Ce livret est sous licence Creative Commons CC BY-NC 4.0. 
